...
class Post(models.Model):
    ...
    descripcion_imagen7=models.CharField(max_length=400, unique=True, blank=True, null=True)
    image8 = models.ImageField(upload_to='images/',blank=True, null=True)
    descripcion_imagen8=models.CharField(max_length=400, unique=True, blank=True, null=True)
    image9 = models.ImageField(upload_to='images/',blank=True, null=True)
    descripcion_imagen9=models.CharField(max_length=400, unique=True, blank=True, null=True)
    image10 = models.ImageField(upload_to='images/',blank=True, null=True)
    descripcion_imagen10=models.CharField(max_length=400, unique=True, blank=True, null=True)
    image11 = models.ImageField(upload_to='images/',blank=True, null=True)
    descripcion_imagen11=models.CharField(max_length=400, unique=True, blank=True, null=True)
    class Meta:
        ordering = ['-created_on']
